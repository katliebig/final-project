  ...
  return (
    <div className="accordion-container">
      ...
      <Collapsible trigger="Who made this?">
        <p>
          This site was made as the final project of Technigo's Frontend Development bootcamp, by Katharina Liebig and Erika Andersson Porath.
        </p>
      </Collapsible>
      ...
      <Collapsible trigger="Will the page be updated?">
        <p>
          Yes, there will probably be additions to the attributes in the creator and hopefully have more races added.
        </p>
      </Collapsible>
    </div>
  )
